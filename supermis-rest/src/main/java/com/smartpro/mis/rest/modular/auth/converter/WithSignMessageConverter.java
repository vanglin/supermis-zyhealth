package com.smartpro.mis.rest.modular.auth.converter;
...
import com.smartpro.mis.rest.common.exception.BizExceptionEnum;
import com.smartpro.mis.rest.config.properties.JwtProperties;
import com.smartpro.mis.rest.modular.auth.security.DataSecurityAction;
import com.smartpro.mis.rest.modular.auth.security.impl.Base64SecurityAction;
import com.smartpro.mis.rest.modular.auth.util.JwtTokenUtil;
...
//    @Autowired
    DataSecurityAction dataSecurityAction = new Base64SecurityAction();
...
//        String json = "abvcccc";
        ...
        if (encrypt.equals(baseTransferEntity.getSign())) {
            ...
            throw new SupermisException(BizExceptionEnum.SIGN_ERROR);
        }
