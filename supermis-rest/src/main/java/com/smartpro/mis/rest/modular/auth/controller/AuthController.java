...
import com.smartpro.mis.rest.modular.auth.controller.dto.AuthRequest;
import com.smartpro.mis.rest.modular.auth.controller.dto.AuthResponse;
...
public class AuthController {
    ...
    public ResponseEntity<?> createAuthenticationToken(AuthRequest authRequest) {
        ...
        if (validate) {
            ...
            throw new SupermisException(BizExceptionEnum.AUTH_REQUEST_ERROR);
        }
    }
}
