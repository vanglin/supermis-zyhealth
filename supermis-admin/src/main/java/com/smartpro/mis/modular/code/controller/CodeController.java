package com.smartpro.mis.modular.code.controller;

import com.smartpro.mis.core.base.controller.BaseController;
import com.smartpro.mis.core.datasource.DruidProperties;
import com.smartpro.mis.generator.action.config.WebGeneratorConfig;
import com.smartpro.mis.generator.action.model.GenQo;
import com.smartpro.mis.modular.code.factory.DefaultTemplateFactory;
import com.smartpro.mis.modular.code.service.TableService;
...
//    @ApiOperation("生成代码")
    ...
    public Object generate(GenQo genQo) {
        ...
        webGeneratorConfig.doSupermisGeneration();
        return SUCCESS_TIP;
    }
}
