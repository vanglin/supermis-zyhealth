...
import com.smartpro.mis.core.common.constant.dictmap.MenuDict;
import com.smartpro.mis.core.common.constant.factory.ConstantFactory;
import com.smartpro.mis.core.common.constant.state.MenuStatus;
...
import com.smartpro.mis.core.support.BeanKit;
import com.smartpro.mis.modular.system.model.Menu;
import com.smartpro.mis.modular.system.service.IMenuService;
import com.smartpro.mis.modular.system.warpper.MenuWarpper;
import com.smartpro.mis.core.base.controller.BaseController;
import com.smartpro.mis.core.base.tips.Tip;
import com.smartpro.mis.core.common.annotion.BussinessLog;
import com.smartpro.mis.core.common.annotion.Permission;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new SupermisException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new SupermisException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
