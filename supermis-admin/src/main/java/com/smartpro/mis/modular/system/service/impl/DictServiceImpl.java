...
import com.smartpro.mis.core.common.constant.factory.MutiStrFactory;
import com.smartpro.mis.modular.system.dao.DictMapper;
...
import com.smartpro.mis.modular.system.dao.DictMapper;
import com.smartpro.mis.modular.system.model.Dict;
import com.smartpro.mis.modular.system.service.IDictService;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
        ...
        if (dicts != null && dicts.size() > 0) {
            throw new SupermisException(BizExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new SupermisException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }
