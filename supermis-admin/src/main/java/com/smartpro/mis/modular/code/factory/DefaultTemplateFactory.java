package com.smartpro.mis.modular.code.factory;


import com.smartpro.mis.SupermisApplication;
import com.smartpro.mis.SupermisApplication;
import com.smartpro.mis.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("smartpro");
        genQo.setProjectPackage(SupermisApplication.class.getPackage().getName());
