...
package com.smartpro.mis.core.flowable;
 ...
 */
public class SupermisDefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    public SupermisDefaultProcessDiagramGenerator() {
        this(1.0);
    }

    // The instructions on how to draw a certain construct is
    // created statically and stored in a map for performance.
    public SupermisDefaultProcessDiagramGenerator(final double scaleFactor) {
        // start event
