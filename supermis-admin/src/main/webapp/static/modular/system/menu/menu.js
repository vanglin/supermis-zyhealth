...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: '菜单编号', field: 'code', align: 'center', valign: 'middle', sortable: true, width: '14%'},
        {title: '菜单父编号', field: 'pcode', align: 'center', valign: 'middle', sortable: true, width: '14%'},
        {title: '请求地址', field: 'url', align: 'center', valign: 'middle', sortable: true, width: '18%'},
