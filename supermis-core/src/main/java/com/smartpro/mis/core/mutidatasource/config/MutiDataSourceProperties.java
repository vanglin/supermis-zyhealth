package com.smartpro.mis.core.mutidatasource.config;
 ...
 */
@Component
@ConfigurationProperties(prefix = "supermis.muti-datasource")
public class MutiDataSourceProperties {

    private String defaultDataSourceName = "dataSourceSupermis";
