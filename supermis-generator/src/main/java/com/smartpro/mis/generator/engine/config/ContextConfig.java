package com.smartpro.mis.generator.engine.config;
...
public class ContextConfig {
    ...
    private String templatePrefixPath = "supermisTemplate/advanced";
    private String projectPath = "D:\\ideaSpace\\supermis";//模板输出的项目目录
    ...
    private String proPackage = "com.smartpro.mis.admin";
    private String coreBasePackage = "com.smartpro.mis.core";
    private String modelPackageName = "com.smartpro.mis.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.smartpro.mis.modular.system.dao";    //model的dao
