package com.smartpro.mis.generator.action.config;
...
import com.smartpro.mis.core.util.FileUtil;
import com.smartpro.mis.generator.engine.SimpleTemplateEngine;
import com.smartpro.mis.generator.engine.base.SupermisTemplateEngine;
import com.smartpro.mis.generator.engine.config.ContextConfig;
import com.smartpro.mis.generator.engine.config.SqlConfig;
import com.smartpro.mis.core.util.FileUtil;
import com.smartpro.mis.generator.engine.SimpleTemplateEngine;
import com.smartpro.mis.generator.engine.base.SupermisTemplateEngine;
import com.smartpro.mis.generator.engine.config.ContextConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doSupermisGeneration() {
        SupermisTemplateEngine SupermisTemplateEngine = new SimpleTemplateEngine();
        SupermisTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        SupermisTemplateEngine.setSqlConfig(sqlConfig);
        SupermisTemplateEngine.setTableInfo(tableInfo);
        SupermisTemplateEngine.start();
    }
}
