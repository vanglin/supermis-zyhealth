package com.smartpro.mis.generator.engine.base;
 ...
 */
public abstract class SupermisTemplateEngine extends AbstractTemplateEngine {

    private GroupTemplate groupTemplate;

    public SupermisTemplateEngine() {
        initBeetlEngine();
    }
